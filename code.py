...
while True:
    if not timestamp or ((time.monotonic() - timestamp) > refresh_rate):  # Refresh rate in seconds
        try:
            ...
            if cheerlights_color in list(): #('green', 'orange'):
            ...
            if cheerlights_color in list(): #('cyan', 'purple'):
            ...
            if cheerlights_color in ('green', 'orange', 'cyan', 'white', 'yellow'):
                if cheerlights_color == 'white':
                    chase_color = WHITE
                elif cheerlights_color == 'yellow':
                    chase_color = YELLOW
                elif cheerlights_color == 'cyan':
                    chase_color = CYAN
                elif cheerlights_color == 'purple':
                    chase_color = PURPLE
                elif cheerlights_color == 'green':
                    chase_color = GREEN
                elif cheerlights_color == 'orange':
                    chase_color = ORANGE
                elif cheerlights_color == 'purple':
